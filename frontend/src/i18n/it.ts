...
export const it = {
  ...
  pages: {
    search: {
      ...
      inputLabel: "Cerca nella documentazione",
      inputPlaceholder: "Es. coppia di serraggio testata RS-30",
      submit: "Cerca",
      filterLang: "Lingua",
      filterType: "Tipo",
      langAll: "Tutte",
      ...
      emptyHint: "Prova con altri termini o rimuovi i filtri.",
      initial: "Digita una domanda o alcune parole chiave e premi Cerca.",
    ...
    users: {
      ...
      colName: "Nome",
      colRole: "Ruolo",
      colCollections: "Collezioni",
      colStatus: "Stato",
      roleAdmin: "Admin",
      roleUser: "Utente",
      statusActive: "Attivo",
      statusInvited: "Invito inviato",
      ...
      modal: {
        title: "Invita utente",
        subtitle: "L'utente riceverà un link di attivazione valido sulla rete aziendale.",
        email: "Email",
        emailPlaceholder: "nome.cognome@azienda.it",
        name: "Nome",
        namePlaceholder: "Nome e cognome",
        role: "Ruolo",
        collections: "Collezioni accessibili",
        note: "i permessi si applicano a ricerca, chat e visualizzatore",
        cancel: "Annulla",
        submit: "Invia invito",
        error: "Impossibile invitare l'utente. Verifica i dati e riprova.",
        noCollections: "Nessuna collezione disponibile. Creane una dalle Fonti.",
      },
    },
    onboarding: {
